...
class App extends React.Component {
    ...
    setStateWithUpdatedList(list, newSize) {
        this.setState(prevState => ({
            listKeyPairMarkedForDeletion : prevState.listKeyPairMarkedForDeletion,
            currentList : list,
            sessionData : this.state.sessionData
    ...
    addDeleteSongTransaction = () => {
        let transaction = new DeleteSong_Transaction(this, this.state.indexToDelete, this.state.songMarkedForDeletion);
        this.tps.addTransaction(transaction);
    ...
    addEditSongTransaction = (t, a, y, oldT, oldA, oldY) => {
        let transaction = new EditSong_Transaction(this, this.state.indexToEdit, t, a, y, oldT, oldA, oldY);
        this.tps.addTransaction(transaction);
    ...
    markSongForDeletion = (song, index) => {
        console.log('incoming deletion at index ' + index)
    ...
    markSongForEdit = (song, index) => {
        this.setState(prevState => ({
            ...
            document.getElementById("title-song").value = song.title;
            document.getElementById("artist-song").value = song.artist;
            document.getElementById("youtube-song").value = song.youTubeId;
        })
    }
